...
import { LogLevel, Log } from '../api/services/log';
...
export default class Deploy extends Command {
  ...
  public static description: string =
    `Deploys the scripts in the working directory according to its ${STACKPATH_CONFIGFILE_PATH} configuration file.`;
  ...
  public static flags: flags.Input<any> = {
    ...
    force: flags.boolean({ char: 'f', description: 'Force recreation of scripts if they do not exist. Defaults to false', default: false }),
  };
